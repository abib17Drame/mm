...
class AideurBaseDeDonnees {
  ...
  _initDatabase() async {
    ...
    // Initialisation conditionnelle pour Windows/Linux/macOS
    if (!kIsWeb && defaultTargetPlatform != TargetPlatform.android) {
      print('Initializing FFI for desktop platform');
      try {
        // Import conditionnel pour éviter les problèmes sur Android
        await _initializeFfiForDesktop();
        print('FFI initialization successful');
      } catch (e) {
        print('Desktop FFI initialization failed: $e');
      }
    } else {
      print('Skipping FFI initialization for Android/Web');
    }
  ...
  /// Initialise FFI pour desktop (Windows/Linux/macOS)
  Future<void> _initializeFfiForDesktop() async {
    // Import dynamique pour éviter les problèmes de compilation sur Android
    try {
      // Utiliser une approche différente pour éviter l'import direct
      await _initFfiSafely();
    } catch (e) {
  ...
  Future<void> _initFfiSafely() async {
  ...
  /// Initialisation spécifique pour desktop
  Future<void> _initDesktopDatabase() async {
    // Cette méthode sera implémentée avec les imports appropriés
    // Pour l'instant, on laisse la base de données utiliser la factory par défaut
    print('Desktop database initialization skipped for now');
  }
  ...
  List<Khatma> _getDonneesInitiales() {
    return [
      Khatma(jour: "الأربعاء", verser1: "الحزب 59 : عَمَّ \nمن النبأ إلى الطارق", verser2: "الحزب 60 : سَبِّحِ \n من الأعلى إلى الناس", verser3: "الحزب 1 : الم \nمن الفاتحة إلى الآية 75 من البقرة."),
      Khatma(jour: "الخميس", verser1: "الحزب 2 : وَإِذَا لَقُوا\nمن الآية 76 إلى الآية 141 من البقرة", verser2: "الحزب 3 : سَيَقُولُ السُّفَهَاء\n من الآية 142 إلى الآية 202 من البقرة", verser3: "الحزب 4 : وَاذْكُرُواْ اللّه\nمن الآية 203 إلى الآية 252 من البقرة"),
      Khatma(jour: "الجمعة", verser1: "سورة الكهف", verser2: "الحزب 5 : تِلْكَ الرُّسُل\n من الآية 253من البقرة إلى الآية 14 من آل عمران", verser3: "الحزب 6 : قُلْ أَؤُنَبِّئُكُم \nمن الآية 15 إلى الآية 90 من آل عمران"),
      Khatma(jour: "السبت", verser1: "الحزب 7 : لَن تَنَالُواْ الْبِرَّ حَتَّى تُنفِقُواْ مِمَّا تُحِبُّون\nمن الآية 91 إلى الآية 170 من آل عمران", verser2: "الحزب 8 : يَسْتَبْشِرُون\n من الآية 171 من آل عمران إلى الآية 23 من النساء", verser3: "الحزب 9 : وَالْمُحْصَنَات\n من الآية 24 إلى الآية 85 من النساء"),
      Khatma(jour: "الأحد", verser1: "الحزب 10 : اللّهُ لا إِلَـهَ إِلاَّ هُو\n من الآية 86 إلى الآية 146 من النساء", verser2: "الحزب 11 : لاَّ يُحِبُّ اللّهُ الْجَهْرَ بِالسُّوَءِ مِنَ الْقَوْل\n من الآية 147 من النساء إلى الآية 24 من المائدة", verser3: "الحزب 12 : قَالَ رَجُلاَن\nمن الآية 25 إلى الآية 81 من المائدة"),
      Khatma(jour: "الاثنين", verser1: "الحزب 13 : لَتَجِدَن\nمن الآية 82 من المائدة إلى الآية 35 الأنعام", verser2: "الحزب 14 : إِنَّمَا يَسْتَجِيب \nمن الآية 36 إلى الآية 110 من الأنعام", verser3: "الحزب 15 : وَلَوْ أَنَّنَا\nمن الآية 111 من الأنعام إلى الآية 3 من الأعراف"),
