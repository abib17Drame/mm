...
class ActionBarActivityDelegateBase extends ActionBarActivityDelegate implements MenuBuilder.Callback {
    ...
    final void ensureSubDecor() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    private void ensureToolbarListMenuPresenter() {
        if (this.mToolbarListMenuPresenter == null) {
            ...
            Context context = new ContextThemeWrapper(this.mActivity, outValue.resourceId != 0 ? outValue.resourceId : android.support.v7.appcompat.R.style.Theme_AppCompat_CompactMenu);
