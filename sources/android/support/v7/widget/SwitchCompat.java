...
public class SwitchCompat extends CompoundButton {
    ...
    private static final int[] TEXT_APPEARANCE_ATTRS = {R.attr.textColor, R.attr.textSize, android.support.v7.appcompat.R.attr.textAllCaps};
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info2) {
        if (Build.VERSION.SDK_INT >= 14) {
            ...
            info2.setClassName(SwitchCompat.class.getName());
