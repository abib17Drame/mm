...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static Object setActionBarUpIndicator(Object info2, Activity activity, Drawable drawable, int contentDescRes) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (info2 == null) {
            info2 = new SetIndicatorInfo(activity);
        }
        SetIndicatorInfo sii = (SetIndicatorInfo) info2;
    ...
    public static Object setActionBarDescription(Object info2, Activity activity, int contentDescRes) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (info2 == null) {
            info2 = new SetIndicatorInfo(activity);
        }
        SetIndicatorInfo sii = (SetIndicatorInfo) info2;
