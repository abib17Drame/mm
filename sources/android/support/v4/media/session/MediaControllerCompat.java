    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo info2) throws RemoteException {
                ...
                if (info2 != null) {
                    pi = new PlaybackInfo(info2.volumeType, info2.audioStream, info2.controlType, info2.maxVolume, info2.currentVolume);
                }
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public PlaybackInfo getPlaybackInfo() {
            try {
                ...
                return new PlaybackInfo(info2.volumeType, info2.audioStream, info2.controlType, info2.maxVolume, info2.currentVolume);
            } catch (RemoteException e) {
