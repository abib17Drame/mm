...
class PopupWindowCompatGingerbread {
    ...
    static void setWindowLayoutType(PopupWindow popupWindow, int layoutType) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
